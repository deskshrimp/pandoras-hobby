this.ph_jerky_02_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_jerky_02";
		this.m.PH_Type = ::PandorasHobby.Blueprint.Type.Food;
		this.m.PreviewCraftable = this.new("scripts/items/supplies/ph_jerky_item");
		this.m.Cost = 50;
		local ingredients = [
			{
	...
	{
		_stash.add(this.new("scripts/items/supplies/ph_jerky_item"));
		_stash.add(this.new("scripts/items/supplies/ph_jerky_item"));
		_stash.add(this.new("scripts/items/supplies/ph_jerky_item"));
		_stash.add(this.new("scripts/items/supplies/ph_jerky_item"));
		_stash.add(this.new("scripts/items/supplies/ph_jerky_item"));
