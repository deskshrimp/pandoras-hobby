this.ph_small_med_02_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_small_med_02";
	...
	{
		return "Produces a small bundle of 10 to 35 medical supplies.";
	}

	function onCraft( _stash )
	{
		local meds = this.new("scripts/items/supplies/medicine_item");
		meds.setAmount(::Math.rand(10, 35));
		_stash.add(meds);
	}
