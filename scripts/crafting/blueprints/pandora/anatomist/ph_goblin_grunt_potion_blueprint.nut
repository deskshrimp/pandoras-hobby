this.ph_goblin_grunt_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_goblin_grunt_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_goblin_grunt_potion_item",
				Num = 1
			},
			{
	...
	{		
		local item = this.new("scripts/items/misc/anatomist/goblin_grunt_potion_item");
