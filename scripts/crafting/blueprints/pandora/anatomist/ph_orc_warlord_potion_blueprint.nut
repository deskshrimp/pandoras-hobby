this.ph_orc_warlord_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_orc_warlord_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_orc_warlord_potion_item",
				Num = 1
			},
			{
	...
	{		
		local item = this.new("scripts/items/misc/anatomist/orc_warlord_potion_item");
