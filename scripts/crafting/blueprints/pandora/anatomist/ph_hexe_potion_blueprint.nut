this.ph_hexe_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_hexe_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_hexe_potion_item",
				Num = 1
			},
			{
	...
	{		
		local item = this.new("scripts/items/misc/anatomist/hexe_potion_item");
