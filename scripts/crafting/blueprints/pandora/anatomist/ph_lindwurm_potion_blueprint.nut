this.ph_lindwurm_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_lindwurm_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_lindwurm_potion_item",
				Num = 1
			},
			{
	...
	{		
		local item = ::new("scripts/items/misc/anatomist/lindwurm_potion_item");
