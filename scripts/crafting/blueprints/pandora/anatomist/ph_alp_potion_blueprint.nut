this.ph_alp_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_alp_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_alp_potion_item",
				Num = 1
			},
			{
	...
	{		
		local item = ::new("scripts/items/misc/anatomist/alp_potion_item");
