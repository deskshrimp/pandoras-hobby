this.ph_fallen_hero_potion_blueprint <- this.inherit("scripts/crafting/blueprint", {
	m = {},
	function create()
	{
		this.blueprint.create();
		this.m.ID = "blueprint.ph_fallen_hero_potion";
		...
		local ingredients = [
			{
				Script = "scripts/items/misc/anatomist/pandora/ph_inc_fallen_hero_potion_item",
				Num = 1
			},
			{
				Script = "scripts/items/misc/ph_zombie_ring_item",
				Num = 1
			}
		];
	...
	{		
		local item = this.new("scripts/items/misc/anatomist/fallen_hero_potion_item");
