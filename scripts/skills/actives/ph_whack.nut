this.ph_whack <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.ph_whack";
		this.m.Name = "Whack";
		...
		this.m.KilledString = "Whacked";
		this.m.Icon = "skills/ph_whack.png";
		this.m.IconDisabled = "skills/ph_whack_sw.png";
		this.m.Overlay = "ph_whack";
		this.m.SoundOnUse = [
