...
::PandorasHobby.MH.require("mod_reforged", "mod_pandoras_followers >= 1.0.0");
::PandorasHobby.MH.conflictWith("mod_legends", "mod_more_followers", "mod_retinue_ups");

::PandorasHobby.MH.queue([">mod_reforged", ">mod_hardened", ">mod_stronghold", ">mod_crock_pot", ">mod_pandoras_followers"], function()
{
