...
::PandorasHobby.MH.queue([">mod_hardened", ">mod_stronghold", ">mod_crock_pot"], function(){
	...
	::Reforged.Mod.Registry.addModSource(::MSU.System.Registry.ModSourceDomain.GitHub, ::PandorasHobby.GitHubURL);
